...
IS_LINES = [
    ...
    ("amortization_of_goodwill_intangibles", "Amortization of Goodwill & Intangibles", False, False),
    ...
    ("other_income",               "Other Non-Operating Income/(Expense)", False, False),
    ("ebt_excluding_unusual_items","EBT Excluding Unusual Items",      True,  True),
    ("merger_restructuring_charges", "Merger & Restructuring Charges", False, False),
    ("impairment_of_goodwill",     "Impairment of Goodwill",           False, False),
    ("gain_loss_on_sale_of_investments", "Gain/(Loss) on Sale of Investments", False, False),
    ("gain_loss_on_sale_of_assets","Gain/(Loss) on Sale of Assets",    False, False),
    ("asset_writedown",            "Asset Writedown",                  False, False),
    ("legal_settlements",          "Legal Settlements",                False, False),
    ("insurance_settlements",      "Insurance Settlements",            False, False),
    ("other_unusual_items",        "Other Unusual Items",              False, False),
